...
public class GuardTrainingEntity extends BaseEntity {
	...
	public GuardTrainingEntity(long id, String createdBy, String modifiedBy, LocalDateTime createdDateTime,
			LocalDateTime modifiedDateTime, UserEntity userId, String name, String mobileNo, String status, String timing,
			Date date, Set<VisitorEntity> visitorSet, Set<SecurityEntity> alertSet, Set<GuardShiftEntity> guardShiftSet,
			GuardSalaryEntity salary) {
